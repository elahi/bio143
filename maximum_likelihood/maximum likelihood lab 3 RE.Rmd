---
title: 'Maximum Likelihood Lab 3: Population Dynamics'
...
> I feel good about these residuals with regard to their spread (dispersion), but there is a clear signal in the central tendency (it goes up and down through time). 
...
> Yes, these residuals appear normal. 
...
plot_var_cov(phi = 0.1)
plot_var_cov(phi = 0.95)
```
